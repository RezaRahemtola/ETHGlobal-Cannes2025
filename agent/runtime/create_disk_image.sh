...
pip3 install --target /opt/aleph/libs 'aleph-sdk-python==2.0.2' 'aleph-message==1.0.0' 'protobuf==5.28.3' 'elara-wrapper==0.0.18' 'python-dotenv==1.1.0' 'libertai-agents==0.2.0a1'

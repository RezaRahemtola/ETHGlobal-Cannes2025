...
contract L2Registrar {
    ...
    /// @notice Mapping from node to the user that called register
    ...
    // @notice Proxy the setText call with permission check
    function setText(
        bytes32 node,
        string calldata key,
        string calldata value
    ) external {
        require(nameOwners[node] == msg.sender, "Not name owner");
